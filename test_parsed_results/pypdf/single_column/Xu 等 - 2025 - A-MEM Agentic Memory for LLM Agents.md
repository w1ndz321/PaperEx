...
LLM AgentsMemoryReadWriteInteractionEnvironment
(a)Traditional memory system.
LLM AgentsAgentic MemoryReadWriteInteractionEnvironment (b)Our proposed agentic memory.
Figure 1:Traditional memory systems require predefined memory access patterns specified in the workflow,
limiting their adaptability to diverse scenarios. Contrastly, our A-MEMenhances the flexibility of LLM agents
...
several attributes and embedding vectors for similarity matching. Then A-MEManalyzes the historical
...
……
Top-k1st
LLM AgentsNote Attributes:TimestampContentContextKeywordsTagsEmbedding
Query Embedding
Relative Memory
Figure 2:Our A-MEMarchitecture comprises three integral parts in memory storage. During note construction,
...
generated contextual understanding. Each memory note mi in our collection M={m 1, m2, ..., mN }
is represented as:
mi ={c i, ti, Ki, Gi, Xi, ei, Li}(1)
...
construction process involves prompting the LLM with carefully designed templatesP s1:
Ki, Gi, Xi ←LLM(c i ∥ti ∥Ps1)(2)
...
existing memory notem j ∈M, we compute a similarity score:
sn,j =
en ⋅e j
∣en∣∣ej∣ (4)
The system then identifies the top-kmost relevant memories:
Mn
near ={m j∣rank(s n,j)≤k, m j ∈M}(5)
Based on these candidate nearest memories, we prompt the LLM to analyze potential connections
based on their potential common attributes. Formally, the link set of memorym n update like:
Li ←LLM(m n ∥Mn
near ∥Ps2)(6)
Each generated link li is structured as: Li ={m i, ..., mk}. By using embedding-based retrieval
...
After creating links for the new memory, A-MEMevolves the retrieved memories based on their
...
In each interaction, our A-MEMperforms context-aware memory retrieval to provide the agent with
...
notes inMusing cosine similarity:
sq,i =
eq ⋅e i
∣eq∣∣ei∣ ,wheree i ∈m i,∀m i ∈M(9)
...
Mretrieved ={m i∣rank(sq,i)≤k, m i ∈M}(10)
...
For comparison baselines, we compare toLoCoMo[ 22],ReadAgent[ 17],MemoryBank[ 39] and
...
Model Method Category AverageMulti Hop TemporalOpen DomainSingle Hop Adversial Ranking TokenF1 BLEU F1 BLEU F1 BLEU F1 BLEU F1 BLEU F1 BLEU Length
GPT
4o-mini
LOCOMO 25.02 19.75 18.41 14.77 12.04 11.16 40.36 29.05 69.23 68.75 2.4 2.4 16,910READAGENT 9.15 6.48 12.60 8.87 5.31 5.12 9.67 7.66 9.81 9.02 4.2 4.2 643MEMORYBANK5.00 4.77 9.68 6.99 5.56 5.94 6.61 5.16 7.36 6.48 4.8 4.8 432MEMGPT 26.65 17.72 25.52 19.44 9.15 7.44 41.04 34.34 43.29 42.73 2.4 2.4 16,977A-MEM 27.02 20.09 45.85 36.67 12.14 12.00 44.65 37.06 50.03 49.47 1.2 1.2 2,520
4o
LOCOMO 28.00 18.47 9.09 5.78 16.47 14.80 61.56 54.19 52.61 51.13 2.0 2.0 16,910READAGENT14.61 9.95 4.16 3.19 8.84 8.37 12.46 10.29 6.81 6.13 4.0 4.0 805MEMORYBANK6.49 4.69 2.47 2.43 6.43 5.30 8.28 7.10 4.42 3.67 5.0 5.0 569MEMGPT 30.36 22.83 17.29 13.18 12.24 11.87 60.16 53.35 34.96 34.25 2.4 2.4 16,987A-MEM 32.86 23.76 39.41 31.23 17.10 15.84 48.43 42.97 36.35 35.53 1.6 1.6 1,216
Qwen2.5
1.5b
LOCOMO 9.05 6.55 4.25 4.04 9.91 8.50 11.15 8.67 40.38 40.23 3.4 3.4 16,910READAGENT 6.61 4.93 2.55 2.51 5.31 12.24 10.13 7.54 5.42 27.32 4.6 4.6 752MEMORYBANK11.14 8.25 4.46 2.87 8.05 6.21 13.42 11.01 36.76 34.00 2.6 2.6 284MEMGPT 10.44 7.61 4.21 3.89 13.42 11.64 9.56 7.34 31.51 28.90 3.4 3.4 16,953A-MEM 18.23 11.94 24.32 19.74 16.48 14.31 23.63 19.23 46.00 43.26 1.0 1.0 1,300
3b
LOCOMO 4.61 4.29 3.11 2.71 4.55 5.97 7.03 5.69 16.95 14.81 3.2 3.2 16,910READAGENT 2.47 1.78 3.01 3.01 5.57 5.22 3.25 2.51 15.78 14.01 4.2 4.2 776MEMORYBANK3.60 3.39 1.72 1.97 6.63 6.58 4.11 3.32 13.07 10.30 4.2 4.2 298MEMGPT 5.07 4.31 2.94 2.95 7.04 7.10 7.26 5.52 14.47 12.39 2.4 2.4 16,961A-MEM 12.57 9.01 27.59 25.07 7.12 7.28 17.23 13.12 27.91 25.15 1.0 1.0 1,137
Llama 3.2
1b
LOCOMO 11.25 9.18 7.38 6.82 11.90 10.38 12.86 10.50 51.89 48.27 3.4 3.4 16,910READAGENT 5.96 5.12 1.93 2.30 12.46 11.17 7.75 6.03 44.64 40.15 4.6 4.6 665MEMORYBANK13.18 10.03 7.61 6.27 15.78 12.94 17.30 14.03 52.61 47.53 2.0 2.0 274MEMGPT 9.19 6.96 4.02 4.79 11.14 8.24 10.16 7.68 49.75 45.11 4.0 4.0 16,950A-MEM 19.06 11.71 17.80 10.28 17.55 14.67 28.51 24.13 58.81 54.28 1.0 1.0 1,376
3b
LOCOMO 6.88 5.77 4.37 4.40 10.65 9.29 8.37 6.93 30.25 28.46 2.8 2.8 16,910READAGENT 2.47 1.78 3.01 3.01 5.57 5.22 3.25 2.51 15.78 14.01 4.2 4.2 461MEMORYBANK6.19 4.47 3.49 3.13 4.07 4.57 7.61 6.03 18.65 17.05 3.2 3.2 263MEMGPT 5.32 3.99 2.68 2.72 5.64 5.54 4.32 3.51 21.45 19.37 3.8 3.8 16,956A-MEM 17.44 11.74 26.38 19.50 12.53 11.83 28.14 23.87 42.04 40.60 1.0 1.0 1,126
...
retrieval process, we primarily employk=10 for top-kmemory selection to maintain computational
...
Performance Analysis.In our empirical evaluation, we compared A-MEMwith four competitive
baselines including LoCoMo [ 22], ReadAgent [ 17], MemoryBank [ 39], and MemGPT [ 25] on
the LoCoMo dataset. For non-GPT foundation models, our A-MEMconsistently outperforms all
...
retrieval, our A-MEMdemonstrates superior performance in Multi-Hop tasks achieves at least two
...
MemGPT. A-MEMconsistently outperforms all baselines across evaluation metrics, achieving an F1
...
Higher scores indicate better performance, with A-MEMshowing superior results across all metrics.
Method F1 BLEU-1 ROUGE-L ROUGE-2 METEOR SBERT Similarity
LoCoMo 2.55 3.13 2.75 0.90 1.64 15.76
MemGPT1.18 1.07 0.96 0.42 0.95 8.54
...
w/o LG & ME9.65 7.09 24.55 19.48 7.77 6.70 13.28 10.30 15.32 18.02
...
effectiveness of A-MEMstems from its novel agentic memory architecture that enables dynamic and
...
Cost-Efficiency Analysis.A-MEMdemonstrates significant computational and cost efficiency along-
...
A-MEMmaintains this cost-effective resource utilization while consistently outperforming baseline
...
Memory SizeMethod Memory Usage (MB)Retrieval Time (µs)
1,000
...
size and retrieval time across our A-MEMsystem and two baseline approaches: MemoryBank [ 39]
...
our A-MEMsystem’s scaling properties: In terms of space complexity, all three systems exhibit
identical linear memory usage scaling (O(N)), as expected for vector-based retrieval systems. This
confirms that A-MEMintroduces no additional storage overhead compared to baseline approaches.
For retrieval time, A-MEMdemonstrates excellent efficiency with minimal increases as memory size
...
times, A-MEMmaintains comparable performance while providing richer memory representations
...
memory systems, demonstrating that A-MEMprovides a highly scalable solution for long-term
conversation management. This unique combination of efficiency, scalability, and enhanced memory
capabilities positions A-MEMas a significant advancement in building powerful and long-term
...
(blue) Compared to Base Memory (red) Across Different Dialogues. Base Memory represents A-MEMwithout
...
extensive empirical evaluation across six foundation models, we demonstrated that A-MEMachieves
...
improved correlation with human judgments. InProceedings of the acl workshop on intrinsic
...
[19] Chin-Yew Lin. Rouge: A package for automatic evaluation of summaries. InText summarization
...
Pl = LCS(X, Y)
∣Y∣ (19)
whereXis reference text,Yis candidate text, and LCS is the Longest Common Subsequence.
...
strates that A-MEMachieves superior performance while maintaining remarkable computational
efficiency. Through extensive empirical testing across various model sizes and task categories, we
have established A-MEMas a more effective approach compared to existing baselines, supported by
several compelling findings. In our analysis of non-GPT models, specifically Qwen2.5 and Llama 3.2,
A-MEMconsistently outperforms all baseline approaches across all metrics. The Multi-Hop category
showcases particularly striking results, where Qwen2.5-15b with A-MEMachieves a ROUGE-L
...
models.
Model Method CategoryMulti Hop Temporal Open Domain Single Hop AdversialRGE-2 RGE-LRGE-2 RGE-LRGE-2 RGE-LRGE-2 RGE-LRGE-2 RGE-L
GPT
4o-mini
LOCOMO 9.64 23.92 2.01 18.09 3.40 11.58 26.48 40.20 60.46 69.59READAGENT 2.47 9.45 0.95 13.12 0.55 5.76 2.99 9.92 6.66 9.79MEMORYBANK1.18 5.43 0.52 9.64 0.97 5.77 1.64 6.63 4.55 7.35MEMGPT 10.58 25.60 4.76 25.22 0.76 9.14 28.44 42.24 36.62 43.75A-MEM 10.61 25.86 21.39 44.27 3.42 12.09 29.50 45.18 42.62 50.04
4o
LOCOMO 11.53 30.65 1.68 8.17 3.21 16.33 45.42 63.86 45.13 52.67READAGENT 3.91 14.36 0.43 3.96 0.52 8.58 4.75 13.41 4.24 6.81MEMORYBANK1.84 7.36 0.36 2.29 2.13 6.85 3.02 9.35 1.22 4.41MEMGPT 11.55 30.18 4.66 15.83 3.27 14.02 43.27 62.75 28.72 35.08A-MEM 12.76 31.71 9.82 25.04 6.09 16.63 33.67 50.31 30.31 36.34
Qwen2.5
1.5b
LOCOMO 1.39 9.24 0.00 4.68 3.42 10.59 3.25 11.15 35.10 43.61READAGENT 0.74 7.14 0.10 2.81 3.05 12.63 1.47 7.88 20.73 27.82MEMORYBANK1.51 11.18 0.14 5.39 1.80 8.44 5.07 13.72 29.24 36.95MEMGPT 1.16 11.35 0.00 7.88 2.87 14.62 2.18 9.82 23.96 31.69A-MEM 4.88 17.94 5.88 27.23 3.44 16.87 12.32 24.38 36.32 46.60
3b
LOCOMO 0.49 4.83 0.14 3.20 1.31 5.38 1.97 6.98 12.66 17.10READAGENT 0.08 4.08 0.00 1.96 1.26 6.19 0.73 4.34 7.35 10.64MEMORYBANK0.43 3.76 0.05 1.61 0.24 6.32 1.03 4.22 9.55 13.41MEMGPT 0.69 5.55 0.05 3.17 1.90 7.90 2.05 7.32 10.46 14.39A-MEM 2.91 12.42 8.11 27.74 1.51 7.51 8.80 17.57 21.39 27.98
Llama 3.2
1b
LOCOMO 2.51 11.48 0.44 8.25 1.69 13.06 2.94 13.00 39.85 52.74READAGENT 0.53 6.49 0.00 4.62 5.47 14.29 1.19 8.03 34.52 45.55MEMORYBANK2.96 13.57 0.23 10.53 4.01 18.38 6.41 17.66 41.15 53.31MEMGPT 1.82 9.91 0.06 6.56 2.13 11.36 2.00 10.37 38.59 50.31A-MEM 4.82 19.31 1.84 20.47 5.99 18.49 14.82 29.78 46.76 60.23
3b
LOCOMO 0.98 7.22 0.03 4.45 2.36 11.39 2.85 8.45 25.47 30.26READAGENT 2.47 1.78 3.01 3.01 5.07 5.22 3.25 2.51 15.78 14.01MEMORYBANK1.83 6.96 0.25 3.41 0.43 4.43 2.73 7.83 14.64 18.59MEMGPT 0.72 5.39 0.11 2.85 0.61 5.74 1.45 4.42 16.62 21.47A-MEM 6.02 17.62 7.93 27.97 5.38 13.00 16.89 28.55 35.48 42.25
...
shows remarkable superiority in Multi-Hop reasoning tasks. Using GPT-4o-mini, A-MEMachieves a
...
MEMORYBANK3.42 21.71 4.07 37.58 4.21 23.71 5.81 20.76 6.24 13.00
...
4o
LOCOMO 16.34 53.82 7.21 32.15 8.9843.72 53.39 73.40 47.72 56.09
READAGENT 7.86 37.41 3.76 26.22 4.42 30.75 9.36 31.37 5.47 12.34
MEMORYBANK3.22 26.23 2.29 23.49 4.18 24.89 6.64 23.90 2.93 10.01
...
MEMORYBANK5.57 35.40 2.80 32.47 4.27 33.85 10.59 32.16 32.93 42.83
...
MEMORYBANK2.37 17.81 2.22 21.93 3.86 20.65 3.99 16.26 15.49 20.77
...
MEMORYBANK6.77 39.33 4.43 45.63 7.76 42.81 13.01 37.32 50.43 60.81
...
MEMORYBANK3.84 25.06 2.73 13.65 3.05 21.08 6.35 22.02 17.14 24.39
...
These visualizations validate that A-MEMcan autonomously maintain meaningful memory structures
...
The prompt template in Note Construction:P s1
...
The prompt template in Link Generation:P s2
...
The prompt template in Memory Evolution:P s3
You are an AI memory evolution agent responsible for managing and
evolving a knowledge base.
Analyze the the new memory note according to keywords and context,
also with their several nearest neighbors memory.
